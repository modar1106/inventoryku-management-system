                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div>
                            ...
                            <input id="sku" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="text" name="sku" value="{{ old('sku') }}" required />
                        </div>

                        <div class="mt-4">
                            <label for="name" class="block font-medium text-sm text-gray-700">Product Name</label>
                            <input id="name" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="text" name="name" value="{{ old('name') }}" required />
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input id="price" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="number" name="price" value="{{ old('price') }}" required />
                            </div>
                            <div>
                                <label for="stock" class="block font-medium text-sm text-gray-700">Initial Stock</label>
                                <input id="stock" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="number" name="stock" value="{{ old('stock') }}" required />
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900">Save Product</button>
                        </div>
                    </form>
